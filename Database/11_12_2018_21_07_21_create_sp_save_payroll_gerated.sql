...
-- =============================================
CREATE PROCEDURE spSaveGeneratedPayroll 
--ADDITIONALS
...
BEGIN
	...
	INSERT INTO PayrollDetails(EmployeeID,AdditionalID,DeductionID,DateFrom,DateTo)
	SELECT @employeeID,@additionalID,@deductionID,@dateFrom,@dateTo;
